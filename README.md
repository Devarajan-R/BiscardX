...
st.image(Image.open(r"C:\Users\DRAGSTA\Desktop\dev\IMG_20230714_150409.png"))          
st.subheader(":green[About the App:] This is a Streamlit web app that integrates EasyOCR, MySQL database, and image processing to extract information from business cards. Users can upload an image of a business card, extract data using EasyOCR, and view the extracted data. The app also allows users to save the extracted information and the uploaded image to a MySQL database. Users can modify or delete existing data in the database and view the updated data. The code establishes a connection with the MySQL database, creates a table to store the extracted data, and provides options for uploading, processing, and managing business card data.")
        
# ------------------UPLOAD AND EXTRACT MENU------------------#

st.image(Image.open(r"C:\Users\DRAGSTA\Desktop\dev\IMG_20230714_150836 (1).png"))
...
if uploaded_card is not None:
        def save_card(uploaded_card):
            with open(os.path.join("C:\\Users\\DRAGSTA\\Desktop\\BizCardX-main\\.venv\\uploaded_cards\\", uploaded_card.name), "wb") as f:
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = "C:\\Users\\DRAGSTA\\Desktop\\BizCardX-main\\.venv\\uploaded_cards\\" + uploaded_card.name
...
# ------------------------MODIFY MENU--------------------#
st.image(Image.open(r"C:\Users\DRAGSTA\Desktop\dev\IMG_20230714_151022.png"))
